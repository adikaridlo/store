...
<div class="page-header navbar">
    <div class="page-header-inner ">
        <div class="page-logo"  id="header-logo">
            <a href="/site/index">
               <center>
                <!-- <img src="<?php echo Yii::getAlias('@web/theme/') ?>assets/pages/img/logo_layout.png" alt="logo" class="logo-default" style="margin-top:7px" width="80"/> -->
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-user">
                    <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" style="color:white">
                        <?php 
                        $name = "Adika"/*Yii::$app->user->identity->name*/;
                        echo  $name; ?>
