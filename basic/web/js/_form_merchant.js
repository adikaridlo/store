function previewFile(file) {
    ...
    var file    = document.querySelector('input[type=file]#merchant-'+ fileId).files[0];
...
$(document).ready(function(){
    ...
    var ownerStatus = $('#merchant-ownership_status');
    var bussinesLocation = $('#merchant-business_location');
